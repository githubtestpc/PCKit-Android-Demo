...
class DateTimeCellStyle(
    _textStyle: CommonTextStyle = CommonTextStyle(),
    ...
    _cellTopPadding: Double = 50.0,
    _cellSameSenderTopPadding: Double = 4.0,
    _cellDifferentSenderTopPadding: Double = 20.0,
    _cellBackgroundColor: Color = dateTimeCellBackgroundColor,
    ...
    _cellElevationColor: Color = Color.LightGray
) : CommonViewStyle {
    ...
    public var cellTopPadding: Double = _cellTopPadding
